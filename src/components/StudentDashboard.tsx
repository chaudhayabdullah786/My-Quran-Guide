          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <div className="text-slate-500 text-sm font-medium mb-2">Courses Completed</div>
                <div className="text-4xl font-bold text-emerald-600">{completedCount}</div>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <div className="text-slate-500 text-sm font-medium mb-2">Courses in Progress</div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 divide-y divide-slate-100">
                ...
                {progress.length === 0 && <div className="p-8 text-center text-slate-500">No activity yet. Start a course!</div>}
              </div>
            </div>
          </div>
        )}
